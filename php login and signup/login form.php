    ...
    <div class="container">
      <div class="forms-container">
        <div class="signin-signup">
          <form action="login form.php" class="sign-in-form" method="POST" autocomplete="">
             <?php
                  if(count($errors)> 0){
                        ?>
          ...
          <form action="user-otp.php" class="sign-up-form" method="POST" autocomplete="">
            ...
            <div class="input-field">
              <i class="fas fa-user"></i>
              <input type="text" name="name" placeholder="Username"  required value="<?php echo $name ?>">
            </div>
            <div class="input-field">
